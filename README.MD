...
* [ ] ### NOW: ### Change list-equals to compare all to *first* item, so you can do like `equals(0 a b c d)` to check if *any* equal zero. Same for not-equal.
...
* [ ] String builder in memory model
